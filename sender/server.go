...
func (r *SenderServer) Init() (err error) {
	...
	fmt.Println("Hello World from SenderServer:", r.Port)
	return
}

func (r *SenderServer) Loop() {
	for {
...
func (r *SenderServer) Stop() {
	r.l.Close()
	r.wg.Wait()
}

// Handles incoming requests.
func (r *SenderServer) handleRequest(conn net.Conn) {
	defer r.wg.Done()
